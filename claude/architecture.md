  ...
  app/
    main/                  # Electron main process
      pipeline/            # download, transcribe, analyze, render steps
                            ...
                            #   providers" above
                            #   glossary.json — hand-maintained Geometry
                            #   Dash term data (glossary.ts loads/matches it)
