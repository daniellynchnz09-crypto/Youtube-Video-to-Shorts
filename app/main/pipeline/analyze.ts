...
- A segment needs an actual moment in it — a reaction, an event, a completed thought, something that happens — not just a setup or transition with nothing in it yet (e.g. the speaker announcing what they're about to play, or navigating a menu, then the segment ends before any actual gameplay, reaction, or payoff). If the substance is on the other side of a cut you'd need to include, extending past 60s, prefer a different segment over one that's mostly preamble.
